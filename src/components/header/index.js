            ...
            <Navbar collapseOnSelect expand="lg" className="py-3" fixed="top">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav>
                        ...
                        <Nav.Link href="" className="px-2 mx-3 text-center" onClick={() => setUpShow(true)}>Sign Up</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
                </Container>
            </Navbar>
                            ...
                            <Col lg={6} md={6} sm={12}>
                                ...
                                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                    <Row className="mb-3">
                                        ...
                                        <div className="text-center my-3">Don't have an account? <Nav.Link onClick={() =>{ setUpShow(true); setInShow(false)}}>Sign Up</Nav.Link></div>
                                    </Row>
                                </Form>
                            </Col>
                            <Col lg={6} md={6}>
